...
const SingleSlide = ({ image, text, p }) => {
  return (
    <div
      ...
      <div className=" text-center">
        <div className="lg:max-w-4xl lg:relative bottom-9 text-white">
          ...
          <Link to='/allFoods'>
            <button className="btn btn-ghost text-xl border-2 hover:border-purple-500 rounded-none hover:bg-purple-300 hover:text-purple-500 mt-6 text-orange-500 border-orange-500">Explore More</button>
          </Link>
        </div>
      </div>
    </div>
